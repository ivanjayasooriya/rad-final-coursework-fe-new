...
import type { NominatimResponse } from "./mapUtils";
      ...
      <div>
        ...
        >
          <iframe
            ...
            src={`https://www.openstreetmap.org/export/embed.html?bbox=${mapCoordinates[1] - 0.05}%2C${mapCoordinates[0] - 0.05}%2C${mapCoordinates[1] + 0.05}%2C${mapCoordinates[0] + 0.05}&layer=mapnik&marker=${mapCoordinates[0]}%2C${mapCoordinates[1]}`}
