        ...
        >
          <iframe
            ...
            src={`https://www.openstreetmap.org/export/embed.html?bbox=${
              mapCoordinates[1] - 0.03
            },${mapCoordinates[0] - 0.02},${mapCoordinates[1] + 0.03},${
              mapCoordinates[0] + 0.02
            }&layer=mapnik&marker=${mapCoordinates[0]},${mapCoordinates[1]}`}
            className="h-full w-full border-0"
            loading="lazy"
          />
        </div>
        <p className="text-xs font-bold text-gray-700 mt-2 uppercase tracking-tight">
          👉 Select a suggestion above to update the pinned location!
        </p>
      </div>
